									...
									<div class="portlet light bordered">
										<div class="portlet-title tabbable-line">
											...
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#tab_1_2" data-toggle="tab">Open<span style="color: #3f6df2;"><i class="fa fa-flask" aria-hidden="true"></i></span> ( ${Count_AssignedToDoctor} )</a></li>
																...
																<div class="portlet-title">
																	<div class="caption font-dark">
																		<i class="icon-settings font-dark"></i> <span
																			...
																			Lab Portal - Assign to Doctor Tokens( ${Count_AssignedToDoctor} )</span>
																	</div>
																				...
																				<c:forEach items="${toDoctor_tokenList}" var="doctor">
																					<tr class="odd gradeX">
																						...
																						<%-- <td><a href="mailto:shuxer@gmail.com">
																								...
																								<td><a
																							href="<c:url value='/assignToDoctor/getViewReportPage/${doctor.id}' />">View</a></td>
																			...
																			<%  %>
																				...
																				<c:forEach items="${assigntoHO_tokenList}" var="lab">
																					<tr class="odd gradeX">
																						...
																						<a href="<c:url value='/assignToDoctor/getAssigToHOTokenInfo/${lab.id}' />">${lab.id}</a></span></td>																					
