	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			action="/AZHealthPortal/assignToDoctor/addReports/${headTokenId }" enctype="multipart/form-data">
                      		...
                      		<%-- 
                      		<c:if test="${!empty doctorReportList}">
                      		<h2><label class="col-md-6 control-label">Doctor Reports: </label></h2>
                      		<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_3">
                                        ...
                                        <tbody>                       
                                            ...
                                            <c:forEach var="i" items="${doctorReportList}" varStatus="status">																
                                                ...
                                                <td><a href="<c:url value='/assignToDoctor/downloadDoctorReport/${i}/${headTokenId }' />"> Download</a></td>
                                                <td><a href="<c:url value='/assignToDoctor/deleteDoctorReport/${i}/${headTokenId }' />"> Delete</a></td>
                                                 <td><a class='deleteDoctorReport' reportName="${i}" tokenId="${headTokenId }"> Delete</a></td>
												</tr>
											</c:forEach>
									...
									<div class="col-md-9">																									
										...
										<table class="table table-bordered table-striped">
											 <tbody>
													...
													<td><input path="reports" id="files" name="files" type="file" multiple="true" class="imageFile btn sbold green" required="required"/></td>												
													<td><input id="btnUpload" class="btnUpload btn btn-labeled btn-primary  btn-xs" type="submit" upload="no" value="Upload Files"></td>	
			...
			action="/AZHealthPortal/assignToDoctor/changeStatus/${headTokenId }" modelAttribute="headToken">
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="user" class="table table-bordered table-striped">
                                        <tbody>
                                            <tr>
                                                <td style="width:15%"> Doctor Comment/Statement:  </td>
                                                <td style="width:50%">
                                                    <form:textarea path="doctorComment" type="text" placeholder="Enter Your Comments" class="form-control" required="required"></form:textarea>
                                                </td>                                               
                                            </tr>                                  
                                            ...
                                            <tr>
                                                ...
                                                <td>                                                
	                                                    <form:select path="completeStatusDoctor" required="required">
	                                                        <option>Select</option>
	                                                        <form:option value="phone">Assigned Reports to H/O </form:option>
