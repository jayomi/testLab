									...
									<div class="portlet light bordered">
										<div class="portlet-title tabbable-line">
											...
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#tab_1_2" data-toggle="tab">Open<span style="color: #3f6df2;"><i class="fa fa-flask" aria-hidden="true"></i></span> ( ${Count_toSRP} )</a></li>
												<li><a href="#tab_1_3" data-toggle="tab">Compleated/Assign To HO<span style="color: #f261db;"><i class="fa fa-upload" aria-hidden="true"></i></span> ( ${Count_assigntoHO_tokenList} )</a></li>
																...
																<div class="portlet-title">
																	<div class="caption font-dark">
																		<i class="icon-settings font-dark"></i> <span
																			...
																			Lab Portal - Assign to Lab Tokens( ${Count_toSRP} )</span>
																	</div>
																			...
																			<%  %>
																				...
																				<c:forEach items="${toSRP_tokenList}" var="doctor">
																					<tr class="odd gradeX">
																						...
																						<td>
																								<%-- <a
																							href="<c:url value='/assignToDoctor/getViewReportPage/${doctor.id}' />">View</a> --%>
																							<a
																							href="<c:url value='/assigToSRP/getViewReportPage/${doctor.id}' />">View</a>
															...
															<div class="portlet light bordered">
																<div class="portlet-title">
																	<div class="caption font-dark">
																		<i class="icon-settings font-dark"></i> <span
																			class="caption-subject bold uppercase">
																			Lab Portal - Assign to H/O - Lab Tokens( ${Count_assigntoHO_tokenList } ) </span>
																	</div>
																	
																</div>
																<div class="portlet-body">
																	
																	<c:if test="${!empty assigntoHO_tokenList}">
																		<table
																			class="table table-striped table-bordered table-hover table-checkable order-column"
																			id="sample_1">
																			<thead>
																			...
																			<%  %>
																				...
																				<c:forEach items="${assigntoHO_tokenList}" var="lab">
																					<tr class="odd gradeX">
																						<td><input type="checkbox" class="checkboxes"
																							value="1" /></td>																					
																						...
																						<a href="<c:url value='/assigToSRP/getAssigToHOTokenInfo/${lab.id}' />">${lab.id}</a></span></td>																						
