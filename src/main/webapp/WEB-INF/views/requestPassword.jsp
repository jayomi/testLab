...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" modelAttribute="loginUser" method="POST" action="/AZHealthPortal/user/requestNewPassword/" id="form_sample_2">
                
                <h3 class="form-title font-green">Reset Password</h3>
               
                	 <div class="form-group">
	                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
	                    <label class="control-label visible-ie8 visible-ie9">Enter Your Username/Email</label>
                ...
                <div class="form-actions">
                  <!--   <button type="submit" class="btn green uppercase">Login</button> -->
                    <input type="submit" class="btn green uppercase" value="Submit"/>                           
                 	 <a href="${pageContext.request.contextPath}/login/" class="btn green">Home</a>           
                </div>
                <div class="create-account">
                    <p>
                       You will receive a E-mail from Allianz Lanka Ltd with a new Password.
                    </p>
                </div>
            </form>
