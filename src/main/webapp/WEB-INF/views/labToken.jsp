					...
					<div class="page-title">
						<h1>
								...
								<div style="float: right;">
									...
									<a href="<c:url value='/assignToLab/getFileUploadPage/${headTokenId}'/>" class="btn sbold green">Upload Medical Reports</a>
								</div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                               	...
                                               	<c:forEach var="i" items="${headToken.medicalReports}" varStatus="status">
											
												<c:if test="${i eq 'MER'}">													
														<a href="<c:url value='/assignToLab/downloadMERReport/'/>" title='Download MER Format' style='color:red;'>${i}</a>
												</c:if>
												<c:if test="${ i ne 'MER'}">
													<a id="fruits" data-type="checklist" data-value="2,3" data-original-title="Select fruits">${i} </a>
												</c:if>
												</c:forEach>
	                                        ...
	                                        <c:if test="${!empty headToken.specialMedicalReports}">
														 <tr>
                                                		<td> Special  Medical Reports:  </td>										
														 <td>
                                                     		<a href="javascript:;" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments"> ${headToken.specialMedicalReports}</a>
                                               			 </td>
                                               			  </tr>
											</c:if>
                                               
                                              <c:if test="${!empty headToken.otherMedicalReports}">
                                              	<tr>
	                                                <td> Other  Medical Reports:  </td>
	                                                <td>
	                                                    <a href="javascript:;" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments"> ${headToken.otherMedicalReports}</a> 
	                                                </td>
