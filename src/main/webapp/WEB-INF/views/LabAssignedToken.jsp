							...
							<div>Token Profile <small>user account page</small>
								<div style="float: right; margin-left:500px;">
									<!-- <button id="sample_editable_1_new"
										...
										Change Lab <i class="fa fa-plus"></i>
									</button> -->
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                             ...
                                             <tr>
                                                <td> Comment :  </td>
                                                <td>
                                                    <a href="javascript:;" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments" style="color: red;"> ${headToken.tokenCreateComment}</a> 
                                                </td>                                                
                                            </tr>
                                             ...
                                             <tr>
                                                <td> Remarks :  </td>
                                                <td>
                                                    <a href="javascript:;" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments" style="color: red;"> ${headToken.remarks}</a> 
                                                </td>                                                
                                            </tr>
