...
public interface HeadTokenService {
	...
	public List<HeadTokenInfo> getTokenListByUser(String UserName,String tokenStatus);//get opened token's userwise-tab agent
